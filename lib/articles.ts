...
**Affiliate note:** Contabo pays a *fixed* commission per new order via Commission Junction — €20 on a VPS 4 up to €115 on a VPS 18, approved after 30 days. Link is cloaked and marked \`sponsored\`.
...
DigitalOcean Droplets (verified 18 July 2026): Basic Shared from **$4/mo** (1 vCPU/1 GB), CPU-Optimized from **$42/mo**. DO has no classic per-sale affiliate — instead a **referral**: your signup gets $200 credit for 60 days, and the referrer gets $25 after you spend $25. If you're sending dev-savvy friends, that's a better deal than a sales commission.
